...
const SignIn = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-4 py-12 bg-black/90">
      ...
      >
        <div className="bg-gradient-to-r from-white/5 via-white/10 to-white/5 backdrop-blur-xl shadow-2xl shadow-black/20 rounded-3xl border border-[#af1aff] p-8 relative overflow-hidden">
          {/* Glass shine overlay */}
          ...
          <div className="flex justify-center mb-6 pb-3">
            <h1 className="text-[32px] ">Welcome to Pritave</h1>
          </div>

          {/* Info text */}
          <p className="text-white/80 text-center mb-8 pb-4">
            To use Pritave you must log into an existing account or create one
          ...
          <div className="space-y-4 pb-5">
            <button
              ...
              className="w-full cursor-pointer bg-white/10 hover:border-[#af1aff] hover:bg-white/15 text-white font-medium py-3 px-4 rounded-xl border border-white/10 transition duration-300 flex items-center justify-center space-x-2 hover:shadow-lg hover:shadow-white/5"
            >
              <svg
                className="w-5 h-5"
                viewBox="0 0 24 24"
          ...
          <p className="mt-8 text-xs text-center text-white/50 pb-3">
            ...
            <Link href="#" className="text-[#af1aff]">
              Terms of Service
            </Link>{" "}
            and acknowledge our{" "}
            <Link href="#" className="text-[#af1aff]">
