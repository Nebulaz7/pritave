...
"
    >
      ...
      <div className="navbar-start relative z-10">
        ...
        "
          >
            ...
            <li>
              <a className="text-white hover:bg-white/20">Join The Waitlist</a>
            </li>
          </ul>
        </div>
        <a className="btn btn-ghost text-xl text-white font-bold border-none">
          Pritave
        </a>
      </div>
      ...
      <div className="navbar-end relative z-10">
        <button className="btn bg-sky-500 text-white px-6 py-3 rounded-4xl shadow-lg shadow-sky-500/50 border-none hover:shadow-pink-sky/75">
          Get Started
        </button>
      </div>
    </div>
